						...
						<div class="total_payment px-5 pt-6 pb-5 background-F9FBFD">
							<div class="payment_content d-flex justify-content-between align-items-center"> 
								<div class="payment_title">
									<p class="total color-2C323A text-lg font-medium m-0 font-montserrat">Total</p>
								</div>
							...
							<div class="complete_btn" style="cursor: pointer;">
									<div class="stripecontainer" style="width=100%; text-align:center;">
										<button type="button" name="btncheckout" id="btncheckout" class="text-white font-poppins text-base font-medium rounded-lg bg-28A271 d-inline-block mt-6 xl-py-3-5 xl-px-12">Secure Your Plan Now</button>
									</div>
